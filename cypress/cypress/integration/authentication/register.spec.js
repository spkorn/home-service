...
it("Happy case - user should register successfully", () => {
...
it("Edge case 1 - user should not be able to register because of one missing checkbox tick", () => {
  cy.visit("http://localhost:3000/register").viewport(1500, 660);
  cy.get("#name").type("Chadchart Sittipun");
  cy.get("#phoneNumber").type("0879316420");
  cy.get("#email").type("Chadchart@sittipun.com");
...
it("Edge case 2 - user should not be able to register because of wrong fillings", () => {
  cy.visit("http://localhost:3000/register").viewport(1500, 660);
