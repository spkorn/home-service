...
orderSummaryRouter.get("/:id", async (req, res) => {
    ...
    const result = await pool.query(`select sub_service.sub_service_name, checkout_quantity.sub_service_quantity, checkout.service_date_time,
    ...
    where checkout.checkout_id = $1`, [newOrderSummary]);
