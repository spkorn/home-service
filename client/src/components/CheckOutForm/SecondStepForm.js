...
function SecondStep(props) {
  ...
  const nextStep = () => {
    if (bookingDateAndTime!=="" && fullAddress.address !== "" && fullAddress.subdistrict !== "" && fullAddress.district !== "" && fullAddress.province !== "" && fullAddress.zipcode !== "") {
      setStep(3);
    } else {
  ...
  return (
    ...
    <div className="px-[10vw] flex mt-8  mx-0 justify-between w-screen">
      <div className=" w-[50vw] mr-[2vw] mb-[125px] py-8 px-6 flex flex-col justify-between border border-grey300 rounded-lg">
          ...
          <div className="flex justify-between mt-4">
            <label>
              <h5 className="text-grey900">
                วันที่-เวลาที่สะดวกใช้บริการ<span className="text-red"> *</span>
              </h5>
              <div className="mt-2">
                <DatePicker
        ...
        <Summary total={total}>
          {bookingDateAndTime!=="" && fullAddress.address !== "" && fullAddress.subdistrict !== "" && fullAddress.district !== "" && fullAddress.province !== "" && fullAddress.zipcode !== ""? null : <p className="text-red my-2">{error}</p>}
        {subService.map((data) => {
          return (
        ...
        {fullAddress.address !== "" || fullAddress.subdistrict !== "" || fullAddress.district !== "" || fullAddress.province !== "" || fullAddress.zipcode !== ""? (
          <div>
            <hr className="text-grey300 my-4" />
            <div >
              <p className="float-left my-2 text-grey700 text-sm font-light">
